...
class cprint(object):
    ...
    def ok(str):
        ...
        """
        print(cprint.colors['OK'] + str + cprint.colors['ENDC'], file=sys.stdout)
    ...
    def info(str):
        ...
        """
        print(cprint.colors['INFO'] + str + cprint.colors['ENDC'], file=sys.stdout)
    ...
    def warn(str):
        ...
        """
        print(cprint.colors['WARNING'] + str + cprint.colors['ENDC'], file=sys.stderr)
    ...
    def fatal(str, interrupt=False):
        """
            ...
            interrupt=True: stops the program
        """
        print(cprint.colors['FATAL'] + str + cprint.colors['ENDC'], file=sys.stderr)
        if interrupt:
            print(cprint.colors['FATAL'] + "Fatal error: Program stopped." + cprint.colors['ENDC'], file=sys.stderr)
            exit(1)
